...
function App() {
  ...
  const options = currencyInfo ? Object.keys(currencyInfo) : [];
   ...
   const swap=()=>{
    ...
    //  const convert=()=>{
    //   setConvertedAmount(amount*currencyInfo[to]  // here changed 
    //   )
    //  }
    const convert = () => {
      if (!currencyInfo || !currencyInfo[to] || isNaN(amount)) {
        // Check if currencyInfo or the target currency is not available yet
